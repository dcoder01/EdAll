  ...
  async (classId, thunkAPI) => {
    try {
      ...
      const [quizzesResponse, assignmentsResponse] = await Promise.all([
        axios.get(`${import.meta.env.VITE_API_URL}/api/v1/quiz/fetch/pending/${classId}`, {withCredentials:true}),
        axios.get(`${import.meta.env.VITE_API_URL}/api/v1/assignment/fetch/pending/${classId}`, {withCredentials:true}),
      ]);
